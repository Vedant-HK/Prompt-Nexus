...
# Curated List of Approaches that are Studied in the context of prompt Optimization or Prompt fine tuning 


This repository has record of research papers and approaches that were studied in aware context of LLM prompt tuning and automatic optimization.
...
- [Papers](#papers)
  ...
  - 2) [Fine-tune Methods](#fine-tune-methods)
  - 3) [Programming](#programming)
  - 4) [Human Perference and Feedback](#human-perference-and-feedback)
  - 5) [Ensemble Methods](#ensemble-methods)
  - 6) [Reinforcement Learning](#reinforcement-learning)
  - 7) [Gradient-free Methods](#gradient-free-methods)
  - 8) [In-Context Learning](#in-context-learning)
  - 9) [Bayesian Optimization](#bayesian-optimization)
...
## 4-- Human Perference and Feedback
